...
class ElasticsearchService:
    """
    Service Layer - Elasticsearch Operations
    
    Handles all Elasticsearch business logic:
    - Document indexing
    - BM25 search
    - Index management
    - Health monitoring
    ...
    def __init__(self, connector: ElasticsearchConnector, index_name: str = "papers"):
        """
        Initialize Elasticsearch service.
        
        Args:
            connector: ElasticsearchConnector instance
            index_name: Name of the index to use
        """
        self.connector = connector
        self.index_name = index_name
        
        logger.info(f"ElasticsearchService initialized with index: {index_name}")
